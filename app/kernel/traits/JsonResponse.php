...
trait JsonResponse{
    ...
    {
        return Container::get(\app\helpers\JsonCode::class);
    }
     ...
     * @return Response
     */
    public function uncompany(string $msg = ''): Response
    {
        return $this->responseWithCode($this->CodeAdapter()::STATUS_UNCOMPANY, [], $msg);
    }
